...
class Books extends Component {
  ...
  submitBookHandler = event => {
    ...
    if (this.state.title && this.state.author) {
      ...
      console.log("Please enter both title and author");
    }
  }

  deleteBooksHandler = bookToDelete => {
    console.log("The X has been clicked on this book: ", bookToDelete);
    API.deleteBook(bookToDelete).then(() => {
      this.loadBooks();
    });
  }
        ...
        <Row>
          <Col size="md-6">
            ...
            <form>
              ...
              <FormBtn onClick={this.submitBookHandler}>Submit Book</FormBtn>
            </form>
          </Col>
          <Col size="md-6 sm-12">
            <Jumbotron>
                ...
                {this.state.books.map(book => {
                  return (
                    <ListItem key={book._id}>
                      ...
                      <DeleteBtn onClick={() => this.deleteBooksHandler(book._id)}/>
                    </ListItem>
                  );
                })}
              </List>
